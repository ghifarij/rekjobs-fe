...
export default function CompanyResetPasswordPage() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      await authCompanyAPI.resetPassword(token, values.password);
      setSuccess(true);
      setTimeout(() => {
      ...
      setErrors({ password: error.message || "Gagal reset password" });
    } finally {
      setLoading(false);
      setSubmitting(false);
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="mt-8">
            <button
              onClick={() => router.push("/auth/company/forgot-password")}
